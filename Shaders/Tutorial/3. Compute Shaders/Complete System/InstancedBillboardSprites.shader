Shader "Workshop/Complete/InstancedBillboardSprites"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
				...
				float scale = smoothstep(0, _ScaleInTime, p.age)*(1 - smoothstep(_MaxLife - _ScaleOutTime, _MaxLife, p.age))*_Scale;
            ...
            fixed4 frag (v2f i) : SV_Target
            {
				...
				fixed4 col = tex2D(_ColorOverLife, i.age/_MaxLife + _Time.x);
